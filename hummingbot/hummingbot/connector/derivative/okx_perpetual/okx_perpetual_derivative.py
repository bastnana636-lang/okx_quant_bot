...
class OkxPerpetualDerivative(PerpetualDerivativePyBase):
    ...
    def _is_request_exception_related_to_time_synchronizer(self, request_exception: Exception):
        ...
        is_time_synchronizer_related = '"code":"50113"' in error_description or '"code":"50102"' in error_description
    ...
    def get_position_side(position_msg: Dict[str, Any]) -> PositionSide:
        if position_msg.get("posSide") == "net":
            position_side = PositionSide.LONG if Decimal(str(position_msg["pos"])) > 0 else PositionSide.SHORT
        else:
